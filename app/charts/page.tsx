...
import { getEstimationData } from "@/lib/estimationData";
...
export default function Charts() {
  ...
  const statusPieData = Object.entries(featureStatusData).map(
    ([status, count]) => ({
  ...
  const priorityPieData = Object.entries(priorityData).map(
    ([priority, count]) => ({
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-blue-600">
            Comprehensive insights and data-driven analysis
          </p>
        </div>
          ...
          <Card className="professional-card">
            <CardContent className="p-12 text-center">
              <div className="text-blue-600">
                ...
                <p className="text-xl">
                  No data available. Create some estimations to see beautiful
                  charts!
                </p>
              </div>
            </CardContent>
                  ...
                  <table className="w-full border-collapse border border-blue-100 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-blue-50">
                        <th className="border border-blue-100 p-4 text-left text-blue-900 font-semibold">
                          Feature
                        </th>
                        <th className="border border-blue-100 p-4 text-left text-blue-900 font-semibold">
                          Status
                    ...
                    <tbody>
                      {dummyFeatures.map((feature) => (
                        <tr key={feature.id} className="table-row-hover">
                          <td className="border border-blue-100 p-4 text-blue-800 font-medium">
                            {feature.name}
                          </td>
                          ...
                          <td className="border border-blue-100 p-4 text-blue-800 font-semibold">
                            {feature.storyPoints}
                          </td>
                          <td className="border border-blue-100 p-4">
                          ...
                          <td className="border border-blue-100 p-4 text-blue-700">
                            {feature.assignedTo}
                          </td>
                          <td className="border border-blue-100 p-4 text-blue-700">
                            {feature.sprint}
