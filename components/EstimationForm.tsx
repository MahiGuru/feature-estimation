            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="border border-blue-200 rounded-xl p-6 mt-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="border-2 border-dashed border-blue-300 rounded-lg p-4 text-center hover:border-green-400 transition-colors">
                            <input
                              type="file"
                              multiple
                    ...
                    {/* Action Buttons */}
                    <div className="flex justify-between items-center my-6 py-4 border-t border-b border-blue-200">
                      <Button
                        type="button"
                        variant="outline"
            ...
            <CardTitle className="section-header">
              ...
              <div className="ml-auto">
                <Badge className="bg-purple-100 text-purple-700 border border-purple-200">
                  {Object.values(teamMembers).reduce((a, b) => a + b, 0)}{" "}
                  members
                </Badge>
              </div>
            </CardTitle>
